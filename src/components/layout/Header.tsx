    ...
    <>
      <header className="sticky top-0 z-40 w-full bg-white border-b border-black text-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[60px] flex items-center justify-between">
          ...
          {/* Zona Central: Logotipo Brutalista / YoungLA style */}
          <div className="text-center">
            <a href="#top" className="inline-block group">
              <h1 className="text-2xl sm:text-3xl font-black tracking-[0.2em] font-display uppercase leading-none">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              onClick={openCart}
              className="flex items-center gap-2 text-xs font-black uppercase tracking-wider px-3 py-1.5 bg-black text-white hover:bg-neutral-800 transition-colors tabular-nums"
      ...
      {leftMenuOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          />
          <div className="relative w-full max-w-xs bg-white h-full p-6 flex flex-col justify-between z-10 border-r border-black shadow-none animate-in slide-in-from-left duration-200">
            <div>
              ...
              <nav className="flex flex-col space-y-4 text-sm font-extrabold uppercase tracking-wider">
                <a
                  href="#catalogo"
                  onClick={() => setLeftMenuOpen(false)}
                  className="py-1 border-b border-neutral-200 hover:pl-2 transition-all flex items-center justify-between"
                >
                ...
                >
                  ...
                  <span className="text-xs text-neutral-400">[0.8s]</span>
                </a>
                <a
                  href="#proceso"
                  onClick={() => setLeftMenuOpen(false)}
                ...
                >
                  ...
                  <span className="text-xs text-neutral-400">[72H]</span>
                </a>
                <a
                  href="#faq"
                  onClick={() => setLeftMenuOpen(false)}
                ...
                >
                  ...
                  <span className="text-xs text-neutral-400">[FAQ]</span>
                </a>
              </nav>
            </div>
